...
- back and forth conversation is needed chat engine is needed or more suitable.
- difference .chat() instead of .query()
- this is the only difference.

![image](https://github.com/user-attachments/assets/e423a7bc-d138-4b33-bed7-856fb8e5ff91)

As you can see more humanizied, conversational response.


![image](https://github.com/user-attachments/assets/f6500f25-11fb-4a33-8724-5c24b58eec15)


it gives detailed answers compared to query()
