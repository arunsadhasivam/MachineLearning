...
==========================================
   ...
   ![image](https://github.com/user-attachments/assets/145238ff-634c-4820-8b54-6396ed43e345)
    ...
    ![image](https://github.com/user-attachments/assets/03b5c1b0-34bf-4ac7-b353-dde3be777c8e)


    ![image](https://github.com/user-attachments/assets/5f654fe9-74a2-4454-9fbf-b8cf09d1653f)




Summary Index Embeddings retriever:
=====================================

- retriever mode set as embeddings.
- Embedding for each chunk will be created in query time and compared with embedding of the query
- Vector embedding of the query will be calculated with the embedding of the each of the textual chunks.



![image](https://github.com/user-attachments/assets/d92d124f-0c40-4779-b597-5d3a58721d69)

see the relevant answer.

![image](https://github.com/user-attachments/assets/6f408544-4241-40dc-b593-dc383f4ee3e0)
