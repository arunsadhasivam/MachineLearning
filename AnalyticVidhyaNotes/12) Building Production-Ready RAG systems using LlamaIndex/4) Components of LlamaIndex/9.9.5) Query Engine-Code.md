...
- previous results we are only retrieving the top K source nodes which contains the information.
- now we are getting the complete response.
- top k nodes probably which contain this information probably page 6 in source node.
